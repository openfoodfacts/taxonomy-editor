...
import { TableContainer, Paper, Table, TableHead, TableRow, Stack, TableCell, Typography, IconButton, Dialog, Alert, Grid, Snackbar, TablePagination } from "@mui/material";
...
export const AdvancedResearchResults = ( {nodeIds, nodeCount=0, taxonomyName, branchName,currentPage, setCurrentPage}: AdvancedResearchResultsType) => {
